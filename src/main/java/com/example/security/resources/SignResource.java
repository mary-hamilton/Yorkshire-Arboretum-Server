...
public class SignResource {
    ...
    public ResponseEntity<SignDto> addNewSign(
            ...
            @RequestParam MultipartFile signImage
    ) {
    ...
    public ResponseEntity<SignDto> editSign(
            ...
            @RequestParam String title,
            @RequestParam String description,
            @RequestParam MultipartFile signImageFile,
            @RequestParam double lat,
            @RequestParam double lon
    ) {
      SignDto editedSignDto = signService.editSign(signId, title, description, lat, lon, signImageFile);
